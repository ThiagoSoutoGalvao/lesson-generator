...
#### Not yet built
- **Interactive Speaking** — chained sequence of 6–8 prompts per the roadmap, likely mixing photo and text prep. No longer blocked on photo sourcing now that the fetch script and a 27-photo bank exist — could reuse `public/images/det-photos/` directly, or fetch a fresh batch with different scene queries if more variety is wanted.
