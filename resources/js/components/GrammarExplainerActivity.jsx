        ...
        <div className="fixed inset-0 flex flex-col z-50" style={bgStyle}>
            ...
            <div className="relative z-10 flex-1 overflow-y-auto px-8 py-6">
                <div className="w-full flex flex-col gap-4">
                    ...
                    {/* Rule */}
                    <div className={`rounded-xl ${accent.bg} ${accent.border} border px-5 py-4`}>
                    ...
                    {/* Form */}
                    {slide.form && (
                        <div className="rounded-xl bg-black/35 border border-white/12 px-5 py-3">
                    ...
                    <div className="flex flex-col gap-2">
                        {slide.examples.map((ex, i) => (
                            <div key={i} className="rounded-xl bg-black/25 border border-white/10 px-5 py-3 flex items-baseline gap-3">
                    ...
                    <div className="flex justify-center gap-3 pt-1">
                        <button onClick={() => setSlideIdx(i => i - 1)} disabled={slideIdx === 0}
                        ...
                        <button onClick={() => setSlideIdx(i => i + 1)} disabled={slideIdx === total - 1}
