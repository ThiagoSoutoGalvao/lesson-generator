...
export default function SentenceTransformationActivity({ activity, onClose, onComplete, hideSave }) {
    ...
    return (
        <div className="fixed inset-0 flex flex-col z-50" style={bgStyle}>
            ...
            {/* Main content */}
            {/* Top-aligned + scrollable, not centered — a long original/answer
                sentence can't push Prev/Next off-screen on a phone. */}
                ...
                <div className="max-w-2xl w-full flex flex-col gap-5">
                    ...
                    <div className="rounded-2xl bg-black/30 backdrop-blur-sm border border-white/15 overflow-hidden">
                        ...
                        <div className="px-8 py-6 border-b border-white/10">
                            ...
                            <p className={`${textColor} ${FONT_SIZES[fontSizeIdx]} leading-snug`}>{item.original}</p>
                        </div>
                        ...
                        <div className="px-8 py-6">
                            ...
                            {revealed ? (
                                ...
                                <p className={`${textColor} ${FONT_SIZES[fontSizeIdx]} leading-snug`}>
                                    {item.stem}{' '}
