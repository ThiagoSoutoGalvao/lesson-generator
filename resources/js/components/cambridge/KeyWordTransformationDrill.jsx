                    ...
                    <div className="max-w-2xl w-full flex flex-col gap-5">
                        <div className="rounded-2xl bg-black/30 backdrop-blur-sm border border-white/15 overflow-hidden">
                            <div className="px-8 py-6 border-b border-white/10">
                                ...
                                <p className={`${textColor} ${SENTENCE_SIZES[fontSizeIdx]} leading-snug`}>{item.original}</p>
                            </div>
                            ...
                            <div className="px-8 py-6">
                                ...
                                {revealed ? (
                                    <p className={`text-green-300 ${SENTENCE_SIZES[fontSizeIdx]} leading-snug font-medium`}>{item.answer}</p>
                                ) : (
                                    <p className={`${textColor} ${SENTENCE_SIZES[fontSizeIdx]} leading-snug`}>
                                        {item.stem}{' '}
